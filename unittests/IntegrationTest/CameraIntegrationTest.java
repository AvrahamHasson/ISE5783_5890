...
public class CameraIntegrationTest {
    ...
    void testIntegrationSphere() {
        ...
        assertEquals(2,
                launcher(new Sphere(new Point(0, 0, -3), 1), cam1),
                wrongNumber);
        ...
        assertEquals(18,
                launcher(new Sphere(new Point(0, 0, -2.5), 2.5), cam2),
                wrongNumber);
        ...
        assertEquals(10,
                launcher(new Sphere(new Point(0, 0, -2), 2), cam3),
                wrongNumber);
        ...
        assertEquals(9,
                launcher(new Sphere(new Point(0, 0, -0.5), 4), cam4),
                wrongNumber);
