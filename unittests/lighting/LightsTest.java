...
public class LightsTest {
    ...
    //for the test with multiple lights we put each light in a different place to see if all of them work
    private final Point          sphereLightPosition2     = new Point(0, 0, 2);

    private final Point          sphereLightPosition3     = new Point(0, 30, 0);

    private final Point          trianglesLightPosition2  = new Point(-20, -60, -110);
    ...
    @Test
    public void sphereMult() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new DirectionalLight(sphereLightColor, new Vector(1, 1, -0.5)));
        scene1.lights.add(new PointLight(sphereLightColor, sphereLightPosition2)
                .setKL(0.001).setKQ(0.0002));
        scene1.lights.add(new SpotLight(sphereLightColor, sphereLightPosition3, new Vector(1, 1, -0.5))
                .setKL(0.001).setKQ(0.0001));
        ImageWriter imageWriter = new ImageWriter("lightSphereMult", 500, 500);
        camera1.setImageWriter(imageWriter) //
                .setRayTracer(new RayTracerBasic(scene1)) //
                .renderImage() //
                .writeToImage(); //
    ...
    public void triangleMult() {
        ...
        ImageWriter imageWriter = new ImageWriter("lightTrianglesMult", 500, 500);
        camera2.setImageWriter(imageWriter) //
                .setRayTracer(new RayTracerBasic(scene2)) //
                .renderImage() //
                .writeToImage(); //
